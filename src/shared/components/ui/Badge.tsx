...
export function Badge({
  ...
  > = {
    ...
    warning: {
      container:
        "bg-amber-50 dark:bg-amber-950/50 border border-amber-200 dark:border-amber-800/80",
    ...
    danger: {
      container:
        "bg-rose-50 dark:bg-rose-950/50 border border-rose-200 dark:border-rose-800/80",
