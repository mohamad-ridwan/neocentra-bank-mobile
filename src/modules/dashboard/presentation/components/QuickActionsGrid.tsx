...
import { useTransactionalAccess } from "@/shared/hooks/useTransactionalAccess";
import { TransactionGuardModal } from "@/modules/account/presentation/components/TransactionGuardModal";
  ...
  return (
    <>
      ...
      <View className="flex-row justify-between mb-6">
        <Pressable
          onPress={() => executeGuardedAction("/transactions/transfer", "Transfer Antarbank")}
        ...
        <Pressable
          onPress={() => executeGuardedAction("/transactions/qris", "Pembayaran QRIS")}
          className="items-center flex-1 active:opacity-75"
        >
        ...
        <Pressable
          onPress={() => executeGuardedAction("/transactions/topup", "Top Up E-Wallet")}
          className="items-center flex-1 active:opacity-75"
        >
        ...
        <Pressable
          onPress={() => executeGuardedAction("/transactions/mutasi", "Riwayat & Mutasi")}
          className="items-center flex-1 active:opacity-75"
        >
      ...
      {/* Modal Dialog Pelindung Transaksi Non-Rekening */}
